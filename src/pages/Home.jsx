                  ...
                  <div className="lg:mt-10">
                      <h3 className="text-white text-2xl font-semibold mb-1">
                          ...
                          <span className="text-white text-lg">
                              I'm John Francis Canlas
                          </span>
                      </h3>
                      <h3 className="text-white text-4xl font-semibold mb-1">
                          ASPIRING{" "}
                          <span className="text-indigo-700 mb-1">
                              WEB DEVELOPER
                          </span>
                      </h3>

                      <p className="text-white text-sm text-justify mb-1">
                          Passionate for building user-friendly websites. I
                          enjoy turning ideas into interactive digital
                          experiences and continuously learning new technologies
                          to improve my skills in front-end and back-end
                          development.
                      </p>
                      ...
                      <div className="flex mt-3 gap-10">
                          ...
                          <a
                              href="./JohnCanlasCV.pdf"
                              target="_blank"
                              download
                              className="text-white ink link-hover">
                              Download CV
                          </a>
                      </div>
                  </div>
          ...
          <div className="p-10">
              <header>
                  <div className="flex gap-2">
                      <hr className="w-9 text-white" />
                      <hr className="w-3 text-white" />
                  </div>
              ...
              <div className="grid grid-cols-1 gap-10 mt-10 mb-10 lg:grid-cols-3 2xl:grid-cols-3">
                  {meList.map((e, i) => (
                      <div
                          key={i}
